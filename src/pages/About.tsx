  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto py-8 px-4 relative z-10 text-white">
        <h2 className="text-3xl font-extrabold mb-4 text-primary">Sobre o Carona Pro Connect</h2>
        <p className="mb-4 text-lg text-white/80">
        O <span className="font-semibold text-primary">Carona Pro Connect</span> é uma plataforma pensada para facilitar a conexão entre colaboradores da Accenture que desejam compartilhar caronas para o trabalho ou eventos.
      </p>
        <div className="mb-6">
        ...
        <p>
          Promover sustentabilidade, economia e integração entre equipes, tornando o deslocamento mais prático, seguro e colaborativo.
        </p>
      </div>
        <div className="mb-6">
